...
RUN mkdir -p /models 
ADD /models/pc-cb-3class_dn21adam_best_model_100ep.bin /models/pc-cb-3class_dn21adam_best_model_100ep.bin
ADD /models/pc-cb-3class_dn21adam_best_model_100ep.xml /models/pc-cb-3class_dn21adam_best_model_100ep.xml
RUN chmod 444 /models/pc-cb-3class_dn21adam_best_model_100ep.bin
RUN chmod 444 /models/pc-cb-3class_dn21adam_best_model_100ep.xml
